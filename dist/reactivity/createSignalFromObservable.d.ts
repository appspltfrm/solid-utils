...
export declare function createSignalFromObservable<T = any>(memo: (prev?: ObservableLike<T>) => ObservableLike<T>, options: InitialValueOption<T> & Options): SignalFromObservable<T>;
export declare function createSignalFromObservable<T = any>(memo: (prev?: ObservableLike<T>) => ObservableLike<T>, options?: CreateSignalFromObservableOption<T | undefined>): SignalFromObservable<T | undefined>;
export {};
